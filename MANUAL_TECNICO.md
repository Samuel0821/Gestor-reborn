...
3.  **product_variants:** Unidades de medida alternativas para productos (ej. Kilo, Bulto).
...
8.  **sale_items:** Detalle de productos vendidos.
9.  **sale_payments:** Desglose de métodos de pago (efectivo, transferencia, cambio).
